...
export ARCH_DIR=`pwd`/../../../thirdparty/arch/
export KERNEL_DIR=$ARCH_DIR/kernels/
export ARCH_72_DIR=$ARCH_DIR/ps/psv_cortexa72_0/
(
...
aarch64-none-elf-gcc -mcpu=cortex-a72 -Wl,-T -Wl,$ARCH_72_DIR/lscript.ld -I../../../thirdparty/aielib/aie-rt/driver/internal/ -I$ARCH_72_DIR/include/ -I../../../include -L$ARCH_72_DIR/lib/ -L../../build/ -o ./${ELF} ../src/graph.cpp -Wl,--start-group,-laiebaremetala72,-lxil,-lgcc,-lc,-lstdc++,--end-group
