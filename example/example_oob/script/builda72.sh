...
aarch64-none-elf-gcc -D__AIE_ARCH__=${__AIE_ARCH__} -mcpu=cortex-a72 -Wl,-T -Wl,$ARCH_72_DIR/lscript.ld -I../../../include/ -I../../../thirdparty/aielib/aie-rt/driver/internal/ -I$ARCH_72_DIR/include/ -L$ARCH_72_DIR/lib/ -L../../build/ -o ./${ELF} ../src/graph.cpp -Wl,--start-group,-laiebaremetala72,-lxil,-lgcc,-lc,-lstdc++,--end-group
