...
PYTHON38=/tools/batonroot/rodin/devkits/lnx64/python-3.8.3/python-3.8.3/lib/
...
#PYTHON38 is used by aiesimu
if [[ ":$LD_LIBRARY_PATH:" == *":$PYTHON38:"* ]]; then
    echo "Library path already exists in LD_LIBRARY_PATH."
else
    # Append library_path to LD_LIBRARY_PATH
    export LD_LIBRARY_PATH="$PYTHON38:$LD_LIBRARY_PATH"
    echo "Library path added to LD_LIBRARY_PATH."
fi
