...
START_JOB 10
  ...
  APPLY_OFFSET_57     @shim00_bd_save, 1, 0xFFFF
  uC_DMA_WRITE_DES    $r0, @uc_dma_bd_save
  WAIT_uC_DMA         $r0
  LOCAL_BARRIER       $lb4, 2
END_JOB
...
START_JOB 11
  LOCAL_BARRIER       $lb4, 2
; enqueue bd0 0_1 to mm2s0
  WRITE_32            0x0109E64, 0x80000000
; enqueue bd0 0_0 to s2mm0
  WRITE_32            0x018544, 0x80000000
  WAIT_TCTS           TILE_0_1, MEM_MM2S_0, 1
  WAIT_TCTS           TILE_0_0, SHIM_S2MM_0, 1

; test purpose
; before sleep, manually clear memtile 0_1 offset 0
...
;
  ...
  .align             16
uc_dma_bd_save:
  UC_DMA_BD         0, 0x00018000, @shim00_bd_save, 9, 0, 1, @memtile_buf
  UC_DMA_BD         0, 0x00108C00, @mem01_bd_save, 11, 0, 0
